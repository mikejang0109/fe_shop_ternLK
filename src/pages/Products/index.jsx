...
const Products = () => {
  ...
  useEffect(() => {
    ...
    const url = `https://raz-be.vercel.app/products${location.search}`;
    axios
      .get(url, {
    ...
    <React.Fragment>
      ...
      <main className="p-[5%] flex justify-center items-start relative">
        ...
        <section className="w-full md:w-[75%] flex flex-col items-center relative h-screen md:h-[1300px]">
          <nav className="flex justify-between items-center pb-3 w-full">
            ...
            <div className="relative ">
              ...
              >
                ...
                <p
                  className="cursor-pointer hover:bg-zinc-50 w-full text-right"
                  onClick={() => addSort("cheapest")}
                >
                  Cheapest
                </p>
                <p
                  className="cursor-pointer hover:bg-zinc-50 w-full text-right"
                  onClick={() => addSort("priciest")}
                >
                  Priciest
                </p>
                <p
          ...
          <div
            className={`${
              errMsg !== null ? "block" : "hidden"
            } font-bold text-lg pt-10`}
          >
            {errMsg}
          </div>
          <div
            className={`grid-cols-2 md:grid-cols-3 w-full ${
          ...
          <div className="btn-group pt-5 ">
            <button
              className={`${
                productList.meta?.totalPage === 1 ? "invisible" : "visible"
