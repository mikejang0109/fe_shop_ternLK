		...
		<React.Fragment>
			...
			<main className="p-[5%] flex justify-center items-start relative">
				...
				<section className="w-full md:w-[75%] flex flex-col items-center relative min-h-screen">
					...
					<div className={`${errMsg !== null ? "block min-h-[1025px]" : "hidden"} font-bold text-lg pt-10`}>
						{errMsg}
					</div>
					<div
						className={`grid-cols-2 md:grid-cols-3 min-h-[1025px] w-full ${errMsg !== null ? "hidden" : "grid"}`}
					>
